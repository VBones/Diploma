...
public final class InterfaceFiltered extends javax.swing.JFrame {
    ...
    private JTextField[][] tFieldArr = new JTextField[10][10];
    ...
    private void chooseFileButtonActionPerformed(ActionEvent evt) {
        ...
        if (openFileResult == JFileChooser.APPROVE_OPTION) {
            ...
            try (BufferedReader reader = new BufferedReader(new FileReader(file))) {
                ...
                Logger.getLogger(InterfaceFiltered.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceFiltered.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
