...
class Realise{
public static final int N_MIN=3;			// минимальное количество вершин
public static final int N_MAX=30;			// максимальное количество вершин

public static final int ALPHA=1;			// вес фермента
public static final int BETTA=3;			// коэффициент эвристики

public static final int T_MAX=100;			// время жизни колонии
public static final int M=20;		// количество муравьев в колонии
public static final int Q=100;			// количество;
public static final double RHO=0.5;			// коэффициент испарения феромона
